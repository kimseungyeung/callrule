...
<%--</div>--%>
<p><div >실수:<input id="edt_27" type="text" value=""></div></p>
<p><div >정수:<input id="edt_30" type="text" value=""></div></p>
<p><div >문자값1:<input id="edt_28" type="text" value=""></div></p>
<p><div >문자값2:<input id="edt_29" type="text" value=""></div></p>
<p><div >배열값:<input id="edt_31" type="text" value=""></div></p>
